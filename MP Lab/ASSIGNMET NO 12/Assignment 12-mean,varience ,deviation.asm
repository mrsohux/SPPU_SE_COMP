...
cal_diff_sqr:
 ...
 Program to calculate mean, variance, standard deviation:
Values are: 102.59, 198.21, 100.67
Mean is000000000000000133.33

Variance is000000000000002073.33

Standard Deviation is000000000000000045.35
